...
{
	$to = 'yashplorer@gmail.com';
	$subject = 'REDesign High School Beta Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U1469"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U1474"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>School:</b></td><td>' . htmlentities($_REQUEST["custom_U1490"],ENT_COMPAT,'UTF-8') . '</td></tr>';
